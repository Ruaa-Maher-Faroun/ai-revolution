  ...
  return (
    <section className='app-container py-16'>
     <div className="text-center mb-12">
      <p className='section-subheader'>AI Technilogies</p>
      <h2 className='section-header '>Diffrent Types of Artificial <span className='gradient-text'>Intelligence Technilogies</span></h2>
      ...
      <div className="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {aiTypes.map((card) => (
          <article className='ai-type-card' key={card.title}>
              <img src={card.image} alt={card.title} className='ai-type-card-image' />
            <div className='p-6'>

              <div className='flex mb-3 items-center'>
                <div className=' ai-type-card-icon'>{card.icon}</div>
