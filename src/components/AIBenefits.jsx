...
const AIBenefits = () => {
  return (
    <section className='app-container py-16 bg-gradient-to-br from-dark to-gray-900 rounded-3xl text-white'>
      <div className="text-center mb-12">
        <p className='section-subheader'>AI Benefits</p>
        <h2 className='section-header '>How AI is <span className='gradient-text'>Transforming Our World</span></h2>
